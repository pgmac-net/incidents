...
| [hal NFS Export Failure](hal-nfs-export-failure.md) | hal/nfs | Apps hang without erroring while every pod reports Ready — hal's rpcbind/mountd die while nfsd stays up on 2049, leaving every cluster NFS mount stale and unremountable |
